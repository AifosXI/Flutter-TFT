...
class TeamsList extends StatelessWidget {
  ...
  final List<Teams> teams = Teams('', '', [], []).teams();
                        ...
                        Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(teams[index].bgImage),
                                fit: BoxFit.cover,
              ...
              Stack(
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(championsList[index]['champion'].icon),
                  ),
                  Positioned(
                    left: 0,
                    right: 0,
                    ...
                    SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: BackdropFilter(
                            ...
                            child: Center(
                              child: Text(championsList[index]['champion'].name, textAlign: TextAlign.center,),
                            ),
                          ),
                        )
                    ),
